...
from code.Const import C_WHITE, WIN_HEIGHT, EVENT_ENEMY, SPAWN_TIME, EVENT_TIMEOUT, \
    TIMEOUT_STEP, TIMEOUT_LEVEL, EVENT_POINT, SPAWN_POINT, EVENT_DIAMOND, SPAWN_DIAMOND, C_LIME
    ...
    def run(self, player_score: list[int]):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                ent.move()
                if ent.name == 'Player1':
                    self.level_text(18, f'Player1 - Health: {ent.health} | Score: {ent.score}', C_LIME, (10, 25))
            ...
            # printed text
            self.level_text(15, f'Timeout: {self.timeout / 1000:.1f}s', C_WHITE, (10, 5))
